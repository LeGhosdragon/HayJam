...
function Dashboard({ onLogout }) {
  ...
  const userButtons = [
    ...
    { label: "Specific fav Thread", onClick: () => {
      setDestinationFalse();
        setOnWayToChat(true); 
    }},
    { 
      label: "Chat with UserX", 
      onClick: () => {
        setDestinationFalse();
        setOnWayToChat(true); 
      }
    ...
    const buttons = [
    { label: "Home but actually forumadwwadwdawdawdawdwa aw dawd w ad wa ", onClick: () => {
      setDestinationFalse();
      setOnWayToHome(true); }},
    { label: "Profile", onClick: () =>  {
      setDestinationFalse();
      setOnWayToProfile(true);}},
    { label: "Settings", onClick: () => {
      setDestinationFalse();
      setOnWayToSettings(true);}},
    { 
      label: "Logout", 
      onClick: () => {
